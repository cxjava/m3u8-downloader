#!/bin/sh
set -e
# Code generated by godownloader on 2023-02-14T12:55:52Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for cxjava/m3u8-downloader

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/cxjava/m3u8-downloader/releases
...
PROJECT_NAME="m3u8-downloader"
OWNER=cxjava
REPO="m3u8-downloader"
BINARY=m3u8-downloader
FORMAT=tar.gz
OS=$(uname_os)
ARCH=$(uname_arch)
PREFIX="$OWNER/$REPO"
